...
* 	available Phase 2 SDP, CQ and Panel datasets and other surveys in the  
...
/*******************************************************************************
*
*  FILENAME:		PMA_HHQFQ_Phase2XS_ResultsBrief.do
*  PURPOSE:			Generate the .xls output for the PMA Phase 2 XS Results Brief
*  CREATED BY: 		Elizabeth Larson (elarso11@jhu.edu)
*  DATA IN:			PMA's Phase2 XS HHQFQ publicly released dataset
*  DATA OUT: 		PMA_COUNTRY_PHASE2_XS_HHQFQ_Analysis_DATE.dta
*  FILE OUT: 		PMA_COUNTRY_PHASE2_XS_HHQFQ_Analysis_DATE.xls
*  LOG FILE OUT: 	PMA_COUNTRY_PHASE2_XS_HHQFQ_Log_DATE.log
*
*******************************************************************************/
