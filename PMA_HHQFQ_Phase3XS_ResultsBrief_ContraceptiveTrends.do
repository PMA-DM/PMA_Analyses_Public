...
* 	generate its Phase 3 cross sectional results briefs using PMA's publicly  
* 	available Household and Female dataset
*
* This .do file will only work on Phase 3 HHQFQ cross sectional datasets. You 
*   can  find the .do files to generate the .xls file outputs for PMA's publicly
* 	available Phase 3 SDP and CQ datasets and other surveys in the  
...
/*******************************************************************************
*
*  FILENAME:		PMA_HHQFQ_Phase3XS_ResultsBrief_ContraceptiveTrends.do
*  PURPOSE:			Generate the .xls output with contraceptive trends for the PMA Phase 3 XS Results Brief
*  CREATED BY: 		Guy Bai (gbai5@jhu.edu)
*  DATA IN:			PMA's Phase1 XS HHQFQ publicly released dataset
*  DATA OUT: 		PMA_COUNTRY_Phase3_XS_ContraceptiveTrends_DATE.dta
*  FILE OUT: 		PMA_COUNTRY_Phase3_XS_ContraceptiveTrends_DATE.xls
*  LOG FILE OUT: 	PMA_COUNTRY_Phase3_XS_ContraceptiveTrends_Log_DATE.log
*
*******************************************************************************/
...
*		your analysis.
*		- For example (Mac): 
*		  local dataset1 "~/Desktop/PMA2020/PMA2018_NGR5_National_HHQFQ_v5_4Nov2019"
*		- For example (PC):
* 		  local dataset1 "~\PMA2018_NGR5_National_HHQFQ_v5_4Nov2019.dta"
...
***** FIRST DATASET *****
* Dataset 1 Directory
local PMAdataset1 "~/Dropbox (Gates Institute)/BF-Burkina/PMABF_Datasets/Round1/Final_PublicRelease/HHQ/PMA2014_BFR1_HHQFQ_v3_6Nov2018/PMA2014_BFR1_HHQFQ_v3_6Nov2018.dta"

* Dates of Data Collection for Dataset 1
local PMAdataset1dates "11-12/2014"

***** SECOND DATASET *****
* Dataset 2 Directory
local PMAdataset2 "~/Dropbox (Gates Institute)/BF-Burkina/PMABF_Datasets/Round2/Final_PublicRelease/HHQ/PMA2015_BFR2_HHQFQ_v3_6Nov2018/PMA2015_BFR2_HHQFQ_v3_6Nov2018.dta" 

* Dates of Data Collection for Dataset 2
local PMAdataset2dates "5-6/2015"

***** THIRD DATASET *****
* Dataset 3 Directory
local PMAdataset3 "~/Dropbox (Gates Institute)/BF-Burkina/PMABF_Datasets/Round3/Final_PublicRelease/HHQ/PMA2016_BFR3_HHQFQ_v3_6Nov2018/PMA2016_BFR3_HHQFQ_v3_6Nov2018.dta"

* Dates of Data Collection for Dataset 3
local PMAdataset3dates "3-5/2016"

***** FOURTH DATASET *****
* Dataset 4 Directory
local PMAdataset4 "~/Dropbox (Gates Institute)/BF-Burkina/PMABF_Datasets/Round4/Final_PublicRelease/HHQ/PMA2016_BFR4_HHQFQ_v4_6Nov2018/PMA2016_BFR4_HHQFQ_v4_6Nov2018.dta"

* Dates of Data Collection for Dataset 4
local PMAdataset4dates "11/2016-1/2017"

***** FIFTH DATASET *****
* Dataset 5 Directory
local PMAdataset5 "~/Dropbox (Gates Institute)/BF-Burkina/PMABF_Datasets/Round5/Final_PublicRelease/HHQFQ/PMA2017_BFR5_HHQFQ_v1_26Aug2018/PMA2017_BFR5_HHQFQ_v1_26Aug2018.dta"
...
***** SIXTH DATASET *****
* Dataset 6 Directory
local PMAdataset6 "~/Dropbox (Gates Institute)/BF-Burkina/PMABF_Datasets/Round6/Final_PublicRelease/HHQFQ/PMA2019_BFR6_HHQFQ_v1_17May2019/PMA2019_BFR6_HHQFQ_v1_20May2019.dta"
...
* PMA Phases *
*****  PMA PHASE 1 Dataset ***** 
local PMAdataset7 "~/Dropbox (Gates Institute)/BF-Burkina/PMABF_Datasets/Phase1/Final_PublicRelease/HQFQ/Previously released version/PMA2020_BFP1_HQFQ_v2.0_1Oct2021/PMA2020_BFP1_HQFQ_v2.0_1Oct2021.dta"

* Dates of Data Collection for Dataset 1
local PMAdataset7dates "01-02/2020"

***** PMA Phase 2 DATASET *****
* Dataset 2 Directory
local  PMAdataset8 "~/Dropbox (Gates Institute)/BF-Burkina/PMABF_Datasets/Phase2/Final_PublicRelease/HQFQ/Previously released versions/PMA2021_BFP2_HQFQ_v1.0_7Oct2021/PMA2021_BFP2_HQFQ_v1.0_1Oct2021.dta"
...
* NOTE: Update PMA dataset below to correspond to local macro for Phase 3 dataset. For example if the local macro for Phase 3 is PMAdataset9, then update that below as `PMAdataset9'
local PMAPhase3dataset `PMAdataset9'
...
* Open Phase 3 dataset
use "`PMAPhase3dataset'",clear
...
* Start log file
log using "`briefdir'/PMA_`country'_Phase3_XS_HHQFQ_ContraceptiveTrends_Log_`date'.log", replace		

* Set local for xls file
local excel "PMA_`country'_Phase3_XS_HHQFQ_ContraceptiveTrends_`date'.xls"

* Set local for dataset
local dataset "PMA_`country'_Phase3_XS_HHQFQ_ContraceptiveTrends_`date'.dta"
