...
/*******************************************************************************
*
*  FILENAME:		PMA_SDP_Phase4XS_ResultsBrief.do
...
*  DATA OUT: 		PMA_COUNTRY_PHASE4_XS_SDP_Analysis_DATE.dta
*  FILE OUT: 		PMA_COUNTRY_PHASE4_XS_SDP_Analysis_DATE.xls
*  LOG FILE OUT: 	PMA_COUNTRY_PHASE4_XS_SDP_Log_DATE.log
*
*******************************************************************************/
...
* Start log file
log using "`briefdir'/PMA_`country'_Phase4_XS_SDP_Log_`date'.log", replace		

* Set local for xls file
local tabout "PMA_`country'_Phase4_XS_SDP_Analysis_`date'.xls"

* Set local for dataset
local dataset "PMA_`country'_Phase4_XS_SDP_Analysis_`date'.dta"
