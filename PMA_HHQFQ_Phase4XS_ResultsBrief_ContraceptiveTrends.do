...
* 	available Phase 4 SDP and CQ datasets and other surveys in the  
...
/*******************************************************************************
*
*  FILENAME:		PMA_HHQFQ_PHASE4XS_ResultsBrief_ContraceptiveTrends.do
*  PURPOSE:			Generate the .xls output with contraceptive trends for the PMA Phase 4 XS Results Brief
*  CREATED BY: 		Claire Silberg (csilber4@jhu.edu)
*  DATA IN:			PMA's Phase4 XS HHQFQ publicly released dataset
*  DATA OUT: 		PMA_COUNTRY_PHASE4_XS_ContraceptiveTrends_DATE.dta
*  FILE OUT: 		PMA_COUNTRY_PHASE4_XS_ContraceptiveTrends_DATE.xls
*  LOG FILE OUT: 	PMA_COUNTRY_PHASE4_XS_ContraceptiveTrends_Log_DATE.log
*
*******************************************************************************/
...
* Open Phase 4 dataset
use "`PMAPHASE4dataset'",clear
...
* Start log file
log using "`briefdir'/PMA_`country'_PHASE4_XS_HHQFQ_ContraceptiveTrends_Log_`date'.log", replace		

* Set local for xls file
local excel "PMA_`country'_PHASE4_XS_HHQFQ_ContraceptiveTrends_`date'.xls"

* Set local for dataset
local dataset "PMA_`country'_PHASE4_XS_HHQFQ_ContraceptiveTrends_`date'.dta"
