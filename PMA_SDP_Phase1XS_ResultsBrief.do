...
/*******************************************************************************
*
*  FILENAME:		PMA_SDP_Phase1XS_ResultsBrief.do
...
*  DATA OUT: 		PMA_COUNTRY_PHASE_XS_SDP_Analysis_DATE.dta
*  FILE OUT: 		PMA_COUNTRY_PHASE_XS_SDP_Analysis_DATE.xls
*  LOG FILE OUT: 	PMA_COUNTRY_PHASE_XS_SDP_Log_DATE.log
*
*******************************************************************************/
...
local tabout "PMA_`country'_Phase1_XS_SDP_Analysis_`date'.xls"

* Set local for dataset
local dataset "PMA_`country'_Phase1_XS_SDP_Analysis_`date'.dta"
...
****************************************
* CHARGING FEES FOR FP SERVICES - - PERCENT OF FACILITIES

* Recode negative values to missing
recode fees_rw -88=. -99=. -77=.
