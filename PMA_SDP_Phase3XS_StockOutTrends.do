...
* 	available Phase 3 HHQFQ and CQ datasets and other surveys in the  
...
/*******************************************************************************
*
*  FILENAME:		PMA_Phase3XS_StockOutTrends.do
*  PURPOSE:			Generate the .xls output with SDP trends for the PMA Phase 3 XS Results Brief
*  CREATED BY: 		Guy Bai (gbai5@jhu.edu)
*  DATA IN:			PMA's XS SDP publicly released datasets from PMA2020 rounds to PMA-Phases
*  DATA OUT: 		PMA_COUNTRY_PHASE3_XS_StockOutTrends_DATE.dta
*  FILE OUT: 		PMA_COUNTRY_PHASE3_XS_StockOutTrends_DATE.xls
*  LOG FILE OUT: 	PMA_COUNTRY_PHASE3_XS_StockOutTrends_Log_DATE.log
*
*******************************************************************************/
...
* Start log file
log using "`briefdir'/PMA_`country'_Phase3_XS_SDP_StockOutTrends_Log_$date.log", replace		

* Set local for xls file
local excel "PMA_`country'_Phase3_XS_SDP_StockOutTrends_$date.xls"

* Set local for dataset
local dataset "PMA_`country'_Phase3_XS_SDP_StockOutTrends_$date.dta"
