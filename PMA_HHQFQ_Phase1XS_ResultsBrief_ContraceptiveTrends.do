...
/*******************************************************************************
*
*  FILENAME:		PMA_HHQFQ_Phase1XS_ResultsBrief_ContraceptiveTrends.do
*  PURPOSE:			Generate the .xls output with contraceptive trends for the PMA Phase 1 XS Results Brief
*  CREATED BY: 		Elizabeth Larson (elarso11@jhu.edu)
*  DATA IN:			PMA's Phase1 XS HHQFQ publicly released dataset
*  DATA OUT: 		PMA_COUNTRY_PHASE_XS_ContraceptiveTrends_DATE.dta
*  FILE OUT: 		PMA_COUNTRY_PHASE_XS_ContraceptiveTrends_DATE.xls
*  LOG FILE OUT: 	PMA_COUNTRY_PHASE_XS_ContraceptiveTrends_Log_DATE.log
*
*******************************************************************************/
