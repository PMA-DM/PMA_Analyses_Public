...
*
* This .do file will only work on Phase 3 SDP cross sectional datasets. You 
*   can  find the .do files to generate the .xls file outputs for PMA's publicly
* 	available Phase 3 Household and Female datasets and other surveys in the  
...
/*******************************************************************************
*
*  FILENAME:		PMA_SDP_Phase3XS_ResultsBrief.do
...
*  DATA OUT: 		PMA_COUNTRY_Phase3_XS_SDP_Analysis_DATE.dta
*  FILE OUT: 		PMA_COUNTRY_Phase3_XS_SDP_Analysis_DATE.xls
*  LOG FILE OUT: 	PMA_COUNTRY_Phase3_XS_SDP_Log_DATE.log
*
*******************************************************************************/
...
local datadir "~/Dropbox (Gates Institute)/BF-Burkina/PMABF_Datasets/Phase3/Final_PublicRelease/SQ/Previoulsy released versions/PMA2022_BFP3_SQ_v1.0_1Sep2022/PMA2022_BFP3_SQ_Questionnaire_v1.0_1Sep2022.dta"
...
* Start log file
log using "`briefdir'/PMA_`country'_Phase3_XS_SDP_Log_`date'.log", replace		

* Set local for xls file
local tabout "PMA_`country'_Phase3_XS_SDP_Analysis_`date'.xls"

* Set local for dataset
local dataset "PMA_`country'_Phase3_XS_SDP_Analysis_`date'.dta"
